<template>
    <div class="editor" v-click-outside="hideMenuInstance">
        <div class="editor-button-panel" style="position: relative; border-bottom: 1px solid #e5e7eb; display: flex;">
            <div class="handler-item group-btn" style="margin-left: auto;">
                <Button @click="AIZMpageVisible=true;" class="button default" style="flex: 1 1 0%; margin: 7px; height: 24px; line-height: 24px; padding: 0px 18px; border-radius: 6px;">
                    <span style="margin-left: 2px; background: linear-gradient(270deg, #d897fd, #33bcfc); background-clip: text; color: transparent; font-weight: 700;">AI生成脚本</span>
                </Button>
                <Button @click="openZMPanel" class="button default" style="flex: 1 1 0%; margin: 7px; height: 24px; line-height: 24px; padding: 0px 18px; border-radius: 6px;">
                    <i-icon-park-outline:align-text-both-one class="icon" style="color:#d14424" />
                    <span style="margin-left: 2px;">脚本总览模式</span>
                </Button>
            </div>
        </div>
