...
const { dialogForExport, showSelectPanel, showSearchPanel, showNotesPanel, showSymbolPanel, showMarkupPanel, showImageLibPanel, showAIPPTDialog, showZMPanel, showAcousticPanel, AIZMpageVisible, showVideoTaskList } = storeToRefs(mainStore)
